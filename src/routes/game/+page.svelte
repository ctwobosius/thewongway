  ...
  const placeCharacter = () => {
    ...
    held_directions.forEach(
      (held_direction) => {
        ...
        character.facing = held_direction;
        character.setAttribute("facing", held_direction);
        

        character.walking = held_direction ? "true" : "false";
...
<div class="frame">
  ...
  <div class="camera">
     <div class="map pixel-art" bind:this={map}>
        <div class="character" bind:this={character} facing="down" walking="true">
